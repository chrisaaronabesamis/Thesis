...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2026 at 07:41 AM
...
CREATE TABLE IF NOT EXISTS `shipping_region_rates` (
...
CREATE TABLE IF NOT EXISTS `sites_setting` (
  `site_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `site_province_shipping_regions` (
  `id` int(11) NOT NULL,
